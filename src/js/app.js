...
let mobileNumberField = document.createElement("input");
mobileNumberField.type = "tel";
mobileNumberField.name = "mobile-number";
mobileNumberField.placeholder = "Mobile Number";

let repeatPasswordField = document.createElement("input");
repeatPasswordField.type = "password";
repeatPasswordField.name = "repeat-password";
repeatPasswordField.placeholder = "Repeat Password";

form.appendChild(mobileNumberField);
...
mobileNumberField.addEventListener("blur", function() {
  ...
  let mobileNumberRegex = /^[0-9]{9}$/;

  if (mobileNumber === "") {
    alert("Mobile number is required.");
    mobileNumberField.focus();
  } else if (!mobileNumberRegex.test(mobileNumber)) {
    alert("Mobile number must contain only numbers and be exactly 9 characters.");
    mobileNumberField.focus();
  }
});
...
repeatPasswordField.addEventListener("blur", function() {
  let repeatPassword = repeatPasswordField.value.trim();
